      ...
      <div className="grid grid-cols-1 gap-3 lg:grid-cols-12">
        ...
        <div className="lg:col-span-3">
          ...
          <div className="mt-3 flex gap-2">
            <button type="button" disabled className="cursor-not-allowed opacity-50 rounded-lg bg-emerald-500/20 px-3 py-2 text-sm font-semibold text-emerald-200 ring-1 ring-emerald-500/30">
              {ctaLabel(layer1.cta.primary)}
            </button>
            {layer1.cta.secondary && (
              <button type="button" disabled className="cursor-not-allowed opacity-50 rounded-lg bg-white/5 px-3 py-2 text-sm font-semibold text-slate-200 ring-1 ring-white/10">
