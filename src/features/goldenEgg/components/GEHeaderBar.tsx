    ...
    <div className="border-b border-white/5 bg-slate-950/80">
      <div className="mx-auto w-full max-w-none px-4 py-4">
        <div className="flex flex-wrap items-center gap-2">
          <div className="h-8 w-8 flex-shrink-0 rounded-lg overflow-hidden"><img src="/assets/scanners/golden-egg.png" alt="Golden Egg icon" className="h-full w-full object-contain p-0.5" /></div>
