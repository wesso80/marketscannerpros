    ...
    return [
      {
        ...
        headers: [
          ...
          // HSTS — only applied in production to avoid breaking local dev
          ...
          }] : []),
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.google-analytics.com https://*.clarity.ms https://plausible.io https://*.stripe.com https://*.posthog.com https://api.coingecko.com https://pro-api.coingecko.com https://www.alphavantage.co wss: ws:",
