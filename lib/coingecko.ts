...
export const COINGECKO_ID_MAP: Record<string, string> = {
  ...
  // Admin shared-scan universe (DEFAULT_WATCHLISTS) — verified against CoinGecko /coins/markets on 2026-09-27
  // (id → symbol + name matched). Static ids avoid a /search call per symbol and a wrong-coin match for tickers
  // like APE, BEAM, PRIME and RON that several coins share.
  'AAVE': 'aave',
  'MKR': 'maker',
  'CRV': 'curve-dao-token',
  'LDO': 'lido-dao',
