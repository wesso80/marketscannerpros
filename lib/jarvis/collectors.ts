...
export function collectUnavailable(): Dataset<null>[] {
  return [
    missing('options', 'Options flow / IV / skew', 'Alpha Vantage REALTIME_OPTIONS', false, 'Single-symbol on-demand only (Pro gated, AV quota); options_metrics_latest has 0 rows. Not ingested.'),
