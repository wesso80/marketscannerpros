...
export async function buildWave2Bundle(deps: Wave2Deps = {}, options: Wave1Options = {}): Promise<Wave1Bundle> {
  ...
  const specs: BlocSpec[] = [
    ...
    { id: 'JP', name: 'Japan', nativeCurrency: 'JPY', classification: 'EXACT', raw: japan, fx: usdjpy, nativeUnitScale: 1e8, fxDirection: 'divide', fxPair: 'USDJPY', fxFailReason: 'USDJPY-fx-failed', definitionBreakpoints: ['BOJ M2 average amounts outstanding (MD02/MAM1NAM2M2MO)'] },
  ];
