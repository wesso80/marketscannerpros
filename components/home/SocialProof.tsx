...
// FeaturePillBar — platform capability highlights (not testimonial social proof)
export default function SocialProof() {
  return (
    <section className="border-b border-white/5 bg-slate-950/60">
      <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-center gap-6 px-4 py-5 sm:gap-10 md:gap-14">
        {stats.map((s) => (
