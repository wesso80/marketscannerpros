...
export default function TerminalShell({ title, subtitle, children, actions, className = '', image }: TerminalShellProps) {
  return (
        ...
        <header className="msp-surface mb-4 rounded-xl border border-[var(--msp-border)] p-4 md:p-5">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="flex items-center gap-3">
              {image && <div className="h-10 w-10 flex-shrink-0 rounded-xl overflow-hidden"><img src={image} alt="" className="h-full w-full object-contain p-0.5" /></div>}
              <div>
