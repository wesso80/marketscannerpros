...
export default function LiquidityLevelsCard({ data }: { data: AdminSymbolIntelligence | null }) {
  if (!data) return <AdminCard title="Liquidity / Levels"><div className="text-white/30 text-sm">Loading…</div></AdminCard>;
  const l = data.levels;
  return (
