...
const GUIDE = [
  ...
  },
  {
    ...
    bullets: ["Review condition state", "Read context stack", "Choose research mode"],
    tip: "Pro tip: Treat dashboard bias as context, not a trigger.",
    cta: { label: "Open Markets", href: "/tools/explorer" },
  },
  {
  ...
  },
  {
    ...
    cta: { label: "Open Equity Explorer", href: "/tools/explorer?tab=equity" },
  },
  {
    title: "Crypto Explorer",
    bullets: ["Regime check", "Momentum + liquidity", "Research routing"],
    tip: "Pro tip: Use crypto explorer with rotation confirmation from market dashboard.",
    cta: { label: "Open Crypto Explorer", href: "/tools/explorer?tab=crypto" },
  },
  {
    title: "Market Movers",
    bullets: ["Find leaders/laggards", "Validate flow", "Build watch candidates"],
    tip: "Pro tip: Use movers to build focus lists, not immediate decisions.",
    cta: { label: "Open Market Movers", href: "/tools/explorer?tab=movers" },
  },
  {
    title: "Economic Calendar",
    bullets: ["Identify event windows", "Pre-event risk", "Post-event follow-through"],
    tip: "Pro tip: Event timing can weaken setup quality when volatility spikes.",
    cta: { label: "Open Economic Calendar", href: "/tools/research?tab=calendar" },
  },
  {
    title: "Commodities",
