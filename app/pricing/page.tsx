...
export default function PricingPage() {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      a: "Pro gives you full market scanning, explorers, news intelligence, trade journal, close calendar, crypto terminal, flow terminal, and portfolio insights. Pro Trader adds the backtesting engine, options terminal, Golden Egg deep analysis, time confluence, catalyst studies, and upgrades ARCA AI to GPT-4.1 for institutional-grade decision intelligence.",
    },
    {
