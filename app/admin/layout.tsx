  ...
  const navSections = [
    {
      ...
      items: [
        ...
        { href: "/admin/symbol/SPY", label: "Symbol Research", code: "SR" },
        { href: "/admin/terminal/SPY", label: "Symbol Terminal (legacy)", code: "ST" },
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/admin/marketing-queue", label: "Marketing Queue", code: "MQ" },
