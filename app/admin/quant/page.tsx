...
/**
 * /admin/quant — Private Operator Terminal (inside Admin Panel)
 *
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3 mb-2">
        <span className="text-emerald-400 font-mono text-sm font-bold tracking-widest">MSP QUANT</span>
        <span className="text-gray-600 text-xs">|</span>
        <span className="text-gray-500 text-xs font-mono">OPERATOR TERMINAL</span>
        <span className="text-gray-600 text-xs font-mono ml-auto">{new Date().toISOString().slice(0, 10)}</span>
      </div>
