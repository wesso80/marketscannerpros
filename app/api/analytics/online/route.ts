...
function classifyPath(path: string): string {
  ...
  if (path.startsWith('/tools/crypto')) return 'Crypto Terminal';
  ...
  if (path.startsWith('/tools/market-movers')) return 'Market Movers';
  if (path.startsWith('/tools/heatmap') || path.startsWith('/tools/sector')) return 'Heatmaps';
  if (path.startsWith('/tools/chart') || path.startsWith('/tools/intraday')) return 'Charts';
  if (path.startsWith('/tools/macro')) return 'Macro Dashboard';
