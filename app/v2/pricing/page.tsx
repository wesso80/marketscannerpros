...
const PLANS: Plan[] = [
  ...
  },
  {
    id: 'pro_trader',
    name: 'Pro Trader',
    tagline: 'Institutional-style workflow with decision engine and derivatives.',
    priceMonthly: 89.99,
    priceYearly: 899.99,
...
const FAQS = [
  { q: "What's the difference between Pro and Pro Trader?", a: 'Pro gives you unlimited scanning, market explorers, heatmaps, intraday charts, news intelligence, trade journal, economic & earnings calendars, crypto command center & terminal, liquidity sweep, options flow, portfolio insights with CSV export, and priority support. Pro Trader adds the backtesting engine, options terminal, options confluence, Golden Egg deep analysis, time confluence scanner, confluence scanner, volatility engine, journal intelligence dock, catalyst studies, and upgrades ARCA AI to GPT-4.1.' },
  { q: 'What does the Free tier include?', a: 'Free gives you the market scanner (5 scans/day), portfolio tracker (up to 3 positions), watchlists, macro dashboard, markets dashboard, and MSP AI Analyst (10 questions/day). No credit card required.' },
  ...
  { q: 'What AI models power ARCA AI?', a: 'Free and Pro tiers use GPT-4o-mini. Pro Trader uses GPT-4.1 for institutional-grade analysis. All tiers get 50 questions/day except Free which gets 10.' },
