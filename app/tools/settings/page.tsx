      ...
      <main className="mx-auto w-full max-w-none space-y-6 px-4 py-6 md:px-6">
          ...
          <div className="rounded-lg border border-slate-700 bg-slate-950/40 p-4">
            ...
            <div className="mt-3 grid gap-2 text-xs text-slate-300 md:grid-cols-3">
              <div className="rounded-md border border-slate-700 bg-slate-900/40 px-3 py-2">
                <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500">Current State</div>
              ...
              <div className="rounded-md border border-slate-700 bg-slate-900/40 px-3 py-2">
                <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500">Risk Mode</div>
                <div className="mt-1 font-semibold text-slate-100">{snapshot?.risk_mode || 'N/A'}</div>
              </div>
              <div className="rounded-md border border-slate-700 bg-slate-900/40 px-3 py-2">
                <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500">Data Health</div>
        ...
        <section className="rounded-xl border border-slate-700 bg-slate-900/50 p-4 md:p-5">
          ...
          {regimeLoading ? (
            ...
            <div className="grid gap-2 text-xs md:grid-cols-4">
              <div className="rounded-md border border-slate-700 bg-slate-900/40 px-3 py-2">
                <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500">Regime</div>
              ...
              <div className="rounded-md border border-slate-700 bg-slate-900/40 px-3 py-2">
                <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500">Risk Level</div>
                <div className="mt-1 font-semibold text-slate-100">{regime.riskLevel.toUpperCase()}</div>
              </div>
              <div className="rounded-md border border-slate-700 bg-slate-900/40 px-3 py-2">
                <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500">Alignment</div>
          ...
          {regime && regime.signals.length > 0 && (
            <div className="mt-3">
              <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500 mb-2">Signal Sources</div>
              <div className="space-y-1">
                {regime.signals.map((sig, i) => (
                  <div key={i} className="flex items-center gap-2 text-xs text-slate-400">
                    ...
                    {sig.stale && <span className="text-amber-500 text-[11px]">STALE</span>}
                  </div>
                ))}
              </div>
            </div>
        ...
        {snapshot && (
          <section className="rounded-xl border border-slate-700 bg-slate-900/50 p-4 md:p-5">
            ...
            <div className="grid gap-2 text-xs md:grid-cols-3 lg:grid-cols-5">
              <div className="rounded-md border border-slate-700 bg-slate-900/40 px-3 py-2">
                <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500">Risk Per Trade</div>
                <div className="mt-1 font-semibold text-slate-100">{((snapshot.caps.risk_per_trade || 0) * 100).toFixed(2)}%</div>
              </div>
              <div className="rounded-md border border-slate-700 bg-slate-900/40 px-3 py-2">
                <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500">Daily R Remaining</div>
              ...
              <div className="rounded-md border border-slate-700 bg-slate-900/40 px-3 py-2">
                <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500">Open Risk</div>
              ...
              <div className="rounded-md border border-slate-700 bg-slate-900/40 px-3 py-2">
                <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500">Consecutive Losses</div>
                <div className="mt-1 font-semibold text-slate-100">{snapshot.session.consecutive_losses}</div>
              </div>
              <div className="rounded-md border border-slate-700 bg-slate-900/40 px-3 py-2">
                <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500">Add-Ons</div>
            ...
            {snapshot.global_blocks.length > 0 && (
              <div className="mt-3">
                <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500 mb-2">Active Blocks</div>
                <div className="space-y-1">
        ...
        <section className="rounded-xl border border-slate-700 bg-slate-900/50 p-4 md:p-5">
          ...
          <div className="grid gap-2 text-xs md:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-md border border-slate-700 bg-slate-900/40 px-3 py-2">
              <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500">Platform</div>
              <div className="mt-1 font-semibold text-slate-100">MarketScanner Pros</div>
            </div>
            <div className="rounded-md border border-slate-700 bg-slate-900/40 px-3 py-2">
              <div className="text-[11px] uppercase tracking-[0.08em] text-slate-500">Version</div>
