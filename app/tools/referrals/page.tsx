  ...
  return (
    <div className="min-h-screen bg-[var(--msp-bg)]">
      <ToolsPageHeader
        ...
        title="Refer & Earn"
        subtitle="Share your link — earn $20 credit for every friend who subscribes. 5 referrals = $500 draw entry."
        icon="🎁"
        backHref="/tools"
      />
          ...
          <>
            ...
            <section className="rounded-xl border border-slate-700 bg-slate-900/50 p-5">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <Step n={2} title="Friend Subscribes" desc="When they sign up for a paid plan, you both get $20 credit on your next invoice." />
