...
- Completed: Terminal route now uses the same compact command-workbench treatment as Dashboard and Golden Egg: slim route-owned compliance, command handoff header, no duplicate global compliance/favorite chrome, and horizontal workbench rail.
